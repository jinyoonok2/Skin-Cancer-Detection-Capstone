...
def get_weighted_data_loader(train_dataset, magnification_factors, id2label):
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=2, shuffle=False, sampler=sampler)
...
weighted_train_dataloader = get_weighted_data_loader(train_dataset=train_dataset, magnification_factors=magnification_factors, id2label=id2label)
