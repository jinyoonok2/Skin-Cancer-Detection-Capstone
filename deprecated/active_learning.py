...
import glob
import shutil
from correction_utils import split_data, correct_data
from model_handler import ModelHandler
from ultralytics import YOLO


class ActiveLearningLoop:
    def __init__(self, model_handler, train_data_path, train_active_path):
        self.model_handler = model_handler
        self.train_data_path = train_data_path  # Pointing to the training data folder
        self.tr = 20
        self.imgsz = 256
        self.epoch = 10
        self.initial_model_path = "yolov8m-seg.pt"
        self.label_map = None
    ...
    def active_learning(self):
        ...
        while True:
            ...
            # Updating paths
            # self.train_data_path = label_path # I will just use existing path
...
if __name__ == "__main__":
    ...
    # parser.add_argument('tr', type=int, help='Training rate') # fixed to 20 now
    # parser.add_argument('imgsz', type=int, help='Size of images') # fixed to 256
    # parser.add_argument('epoch', type=int, help='Number of epochs')  # fixed to 20
    ...
    al = ActiveLearningLoop(model_handler, args.train_data_path, args.train_active_path)
    al.active_learning()

# python active_learning.py datasets\HAM10000 datasets\HAM10000\active_learning yolov8s-seg.pt
# python active_learning.py datasets\HAM10000 datasets\HAM10000\active_learning yolov8s-seg.pt