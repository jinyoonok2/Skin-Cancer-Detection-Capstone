...
from dataset_preprocess.yolo_txt_cascade._train_magnification import augment_factors

class_augment_check = {i: augment_factors[class_name] > 1 for i, class_name in enumerate(augment_factors)}
