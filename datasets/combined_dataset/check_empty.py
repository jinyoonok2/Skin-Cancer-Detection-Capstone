...
#     path = os.path.join('./default', class_name, 'labels')
...
#     labels_path = os.path.join('./default', class_name, 'labels')
#     images_path = os.path.join('./default', class_name, 'images')
#     for filename in os.listdir(labels_path):
#         file_path = os.path.join(labels_path, filename)
#         # Check if the file is empty
#         if os.path.getsize(file_path) == 0:
