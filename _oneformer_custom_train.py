...
from _one_former_custom_dataload import weighted_train_dataloader
import torch
import os
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, num_epochs):  # loop over the dataset multiple times
        ...
        progress_bar = tqdm(enumerate(weighted_train_dataloader), total=len(weighted_train_dataloader))
